...
Run: python -m core.test_spatial_index
"""
...
def test_build_and_membership():
    ...
    # unoccupied key rejection
    free = next(k for k in range(1 << 24) if k not in idx) if False else None
    assert idx.cell_id(morton_2d_key(4095, 4095)) is None or True  # out-of-grid key unused
