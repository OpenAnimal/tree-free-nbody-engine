"""Adaptive CGR88 WGSL kernel gate: compile + counting-sort CSR validation.

Compiles the full `adaptive_cgr88.wgsl` module on a native WebGPU adapter
...
def main():
    ...
    module = device.create_shader_module(code=get_adaptive_cgr88_wgsl_source())
    ...
    print("adaptive_cgr88.wgsl compiled (16 storage + 2 uniform bindings)")
